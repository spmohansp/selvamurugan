...
@section('content')
    <div class="row page-titles">
        <div class="col-md-12 align-self-center">
            <h4 class="theme-cl">Add Empty Beam Delevery</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <form data-toggle="validator" class="padd-20" method="post" action="{{ route('admin.addEmptyBeamDelevery') }}">
                <div class="card">
                    {{ csrf_field() }}
                    <div class="row page-titles">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <div class="text-center">
                                <button id="form-button" class="btn gredient-btn">Add Empty Beam Delevery</button>
                            </div>
                        </div>
                    </div>
                </div>
