                ...
                <div class="row mrg-0">
                        ...
                        <div class="form-group">
                            ...
                            <select name="unit_id" class="form-control" required>
                                @foreach(auth()->user()->getAllUnits() as $Unit)
                                    <option value="{{ $Unit->id }}" {{ ($Unit->id == $IncomeYarn->unit_id)? 'selected':'' }}>{{ $Unit->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="date" value="{{ $IncomeYarn->date }}"
                                required="">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4" id="total_bag_div">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control CalculateYarnBagQuantity" id="total_bag" name="total_bag"
                                value="{{ $IncomeYarn->total_bag }}" required="">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-4" id="total_kg_bag_div">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control CalculateYarnBagQuantity" id="total_kg_bag" name="total_kg_bag"
                                value="{{ $IncomeYarn->total_kg_bag }}" required="">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="net_weight" id="net_weight" value="{{ $IncomeYarn->net_weight }}"
                                readonly="">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="color" value="{{ $IncomeYarn->color }}"
                                required="">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="yarn_count" class="form-control" value="{{ $IncomeYarn->yarn_count }}"
                                required>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        @endif()
        setTimeout(function () {
            $("#sub_customer_id option[value='<?php echo $IncomeYarn->sub_customer_id ?>']").attr(
                "selected", true);
        }, 500);
